...
public final class VClientImpl extends IVClient.Stub {
    ...
    public void bindApplication(final String packageName, final String processName) throws FileNotFoundException {
    ...
    private void bindApplicationNoCheck(String packageName, String processName, ConditionVariable lock) throws FileNotFoundException {
        ...
        File file2=new File(mInitialApplication.getApplicationInfo().nativeLibraryDir+"/libcocos2dlua.so");
             if(file2.exists()&&mInitialApplication.getPackageName().equals("com.KingOfTank.hjtkdg3k")) {
                 Native.hook(mInitialApplication.getApplicationInfo().nativeLibraryDir + "/libcocos2dlua.so", mInitialApplication.getApplicationInfo().packageName);
         }
    }
